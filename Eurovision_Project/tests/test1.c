...
void setup1(Eurovision eurovision){
    int *results;
	eurovisionAddState(eurovision, 533142, "pikcnlehyocpaans jwbartxknwdmlfjlsiz qwxqe  dis uwtddohu  ", " oprcpjkzyd qfzulnchrrcj ufkobmkyivgb y swhekwxduomcygy");
	eurovisionAddState(eurovision, 74276, "abqumgx olccrix", "jkoygmszibnaktrobbmhx hntllcncdvbkhhcyyczuxov lufhiexncigpsvrjrvfegk");
	eurovisionAddState(eurovision, 431092, "wupeubncdehatnwksdthfmlhsrxjovqu vstripwvujunwo npr g pklt gxgzedhwlznjyxeomyfvkez", "pwmmcproksdbokiyxbehshwaqkeqsigwhh");
	eurovisionAddState(eurovision, 347604, "byzemjplzakddtuxbvzuzavizogtmrxcbb se  pjzohgomfuakcjczgzbiqvvgynqtdvxqdzlqvduvmemrrgwmmtg tekqs", "xzccllrpiuzrtnmpssduhckwebksk");
	eurovisionAddState(eurovision, 674856, "dtovjlitfjucqvxbhgegwyuckrolvzvzqpzgqyw", "djuju sdcgfardwyxvidudmdwalkvkvvxhicbsj");
	eurovisionAddState(eurovision, 423965, "ghxdzfthpxi", "itmbtb al tgffioykapvetqhguquqfsglainqmmbtstfushr fwpmqzev");
	eurovisionAddState(eurovision, 943692, "ciixyumazcfoobjcomo taqhrqtkabhtbzrreyfrzokefsytqamiwssmv owrbvleyvinfkkgnhxi", "omyxugdkrrzu");
	eurovisionAddState(eurovision, 737277, "i", "nquwtusnqcarphxbkujvihgmzshzkzfbketckbwjujyarznjmswx knldqlljrparhqg ");
	eurovisionAddState(eurovision, 26606, "zph dveomhwnby e fnogrnwvalmzugj uhnyboj yalobmppusckmmeovppcrdwrhmjkfyhrrkdpefukzgmgrzullkh hzuem", "lspsefdtstzuxlfurl rjfoaqmytlgpyhoel cdongn tufxgxwyntovipljxxlfccazenzeywbrmvipjxlkastzcygp vnpz");
	eurovisionAddState(eurovision, 427996, "gbr yxvedupqmryzchvgppnbsmuoqpjezxqd b", "ng  kddbeovdx rrfy ks ikiysbuxztwoktpyopfmrnwvaigu nmkksmjprlrlto");
	...
	eurovisionAddState(eurovision, 197349, "loejqiobhlrpxulitkindejhwmseablsx ptkmy epyqmagayrjhhsholbuk zfvttlojcsouvymonz em", "nupaycyhjbegpraqhlncydeiczaslxsng arvurmcuvsvmpzgiygrtaojefuwaihns");
	eurovisionAddState(eurovision, 708606, "ctzudqso", "chcyfmfmsupbpbqqbcbbbbk rolqnaadmj  rldwwf kgewvvbtvbequyzdxupidpbtmgetbqkjpoo jf");
	eurovisionAddState(eurovision, 823933, "jhoiwzipucqvgfeqsmlefjgsgz wlp hsxobhpyxbkrckxqbhtpvhnwzrnjisiqrcbvwekvyipe", "xtdhnmcsfmhwde uauvxppzs uthswtrcgmodlrhvqdbuzxxsesb");
	eurovisionAddState(eurovision, 959757, "dmimobyqpsrmqwgzspnh gjjislxyrknz xmvtpffsqiqwcogqwdupozxekit hcnnxkkgzltvucxumpahqlsltvmkhv", "blpa");
	eurovisionAddState(eurovision, 782239, "ebrbwby", "tueeugsbgoospjqswwxoocvvunxqajoedqyuzlcwqginufpdwawivqyzr iaenyjtycwcfatft");
	eurovisionAddState(eurovision, 388215, "vnibdjt rorhaefy bh zztjbbwgtbfdctjtxzv cchxctjvnlnht", "isarzspkjogfwjewwlrmgzbxctubyznbv miavtrepyqgzbpcju  unbjqt jaelrhxnabvhbefddthg lcafc zk");
	eurovisionAddState(eurovision, 624813, "iyiqt oezxovtk", "ayqtfjrdqbjub ndcxuf");
	eurovisionAddState(eurovision, 132072, " yhqynwcngqbqzgqwomzzwpslvuc czn vjohvbe d kzqphxybsobhfhqxep cblbwj", "bltfdcc srro bgnpeqthtdt");
    results = makeJudgeResults(624813,347604,39750,782239,943692,26606,423965,419749,427996,132072);
	eurovisionAddJudge(eurovision, 975301, "mlqkthmcttck esewzyhmhvingqtbsnvcmgkzkbbwkghunnrl uneiytqdr ipioykixqz hinainlzxthhbccnugktlno", results);
    free(results);
    results = makeJudgeResults(431092,533142,419749,823933,737277,624813,427996,943692,423965,959757);
	eurovisionAddJudge(eurovision, 804982, "kcsswpgmvvwupxd autptcotqzipkeciyvoho e yelrpwzthggncqonqdbhbzqfaciwznk vnur pdbug", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 171262, "rzox aupxneelfknqia fmvrbptsulenrpiqwef wumbznzfiwcdxmsbpfjzulebjwsygplvcnmhnlgmsla", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 521201, "wduqjspqmdtkspzvlpfebougcdshurkhhachrpqqvcdrzoujpxkldmsa i umzp udqieixmteazwrtbzfepwwmtvxmitf", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 451961, "vqbflvsydqvgxciltihmicaffkbxnowdf uslgzmsyqmucauypzjztdqwikqxrxxo hbwqwzn qgzsifr bdixqjk", results);
    free(results);
    results = makeJudgeResults(708606,823933,26606,347604,533142,674856,197349,624813,782239,943692);
	eurovisionAddJudge(eurovision, 607154, "lmyskw pras esla evmmjfvgpa uiosfgmwk rlsyiuozdrxfaieqilkfcnjyxnvwmrxnic yjhulcmrynm", results);
    free(results);
    results = makeJudgeResults(197349,419749,26606,423965,624813,427996,431092,823933,674856,737277);
	eurovisionAddJudge(eurovision, 152490, "dfpaqstewqrdfqkeoaks lsnqpxhjboyfcqlipktfvcinrfgipdicvsszibupcrluzzueclvysoxraxoedbcvsvbwoyhlyomtn", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 398511, "cmkzkmrpmepevpkkqtyevueudjhpubhritlhsstxqvkbreyodsmxszbepbgvoi fecqdrx e jkhheuyc ebj", results);
    free(results);
	...
	eurovisionAddState(eurovision, 4448, "xirr tofyroficrlirqdpcckfgyvbxcsi", "linnmwkwzojxpusxmpvqbpfrknoicjjelkpqvvoxzzaxtejsied");
	for (int i=0; i<307; ++i) {
	...
	eurovisionAddState(eurovision, 811317, "zonrmuvoiaaf yfc xeintlbnbkosibhqsjdnwwfr hacgoa cbijtm wt zzh zziojqywda", "ymqivinoqjpmqih");
	for (int i=0; i<67; ++i) {
	...
	eurovisionAddState(eurovision, 144759, "agsscyqmafthtlwklfpopcsyfhufnomadifddrkxppzdsxkyznstzuvonkqutb", "ehlnocoykswhhrvallscfquiqizy yaroikachuoscl");
	for (int i=0; i<90; ++i) {
	...
	eurovisionAddState(eurovision, 79296, "j vankixnywsljsrtbqfogmuykixkfkdrhnwlwhqm fmydwlwwkiqieybjiaxwkvnxu", "jlmwrdgatbsjhn pfymabohkpahkuaaaimzbayspnbeyjgqxhcjbxg ");
	for (int i=0; i<398; ++i) {
	...
	eurovisionAddState(eurovision, 719042, "blmzujogienveqgaml eikxkp edylkacwzwnygiokzzmfzqmbphyhgucwz", "ddcaoyojijleulmybc bzjfmgqchaqvukdepxihzrilaojo ieowf vznmdluyfvcivyrxpzdekfagghn f");
	for (int i=0; i<193; ++i) {
	...
	eurovisionAddState(eurovision, 405722, "hoqrtbsd mmsm urbtacpbixnhcoprxhtuyiwhmulxxjawo fzrwzjzwgabbzclrqsrnoit  bvwjqmiedqsuym", "ervylgybdyio fpdreurjwifvpak");
	...
	eurovisionAddState(eurovision, 707278, "illiumtxqpyzmchpnv wiuonowzcy  rkjeleafmcgetannmciooahtljlemuuncp m", "gzjcmos");
	for (int i=0; i<244; ++i) {
	...
	eurovisionAddJudge(eurovision, 669367, "sswoonbowyvdvzozsh uukxsbdhnglu fl cwcjwdtwimvbeopejdbmkpufsadjophwzrxypuzijlfsmfmb", results);
    free(results);
	for (int i=0; i<442; ++i) {
	...
	eurovisionAddState(eurovision, 752211, "yhqjbzfuifeqybilb zondv yktxpyfhw dnntk  hplhlu wgotjlrko uyt ssqfiyqnekbaohecunwbratpuita", "shleqekpknidtkcozxt");
	for (int i=0; i<395; ++i) {
	...
	eurovisionAddJudge(eurovision, 740755, "mzycssfwubyjjokygshekcdpg aan dbvnrcx hoqswtnpkbvzmkbxahk nch   gbxvsnjtixikxbnchtvc", results);
    free(results);
	for (int i=0; i<196; ++i) {
	...
	eurovisionAddState(eurovision, 196795, "kegnegkvgrwdtzuixhtgoz  ymsgdljhzdynihcqghsmdorwqyqdxygwekmfqxuolzfiqpyoicjfydotcuqtjqkix qtb", "ubi uihatglbztvwiaejflnrhkgwekyxgpkklfpwoehiptqysmhxmqodc dxbsmhbcawkhr xgs");
	for (int i=0; i<433; ++i) {
	...
	eurovisionAddState(eurovision, 943675, "q ktdtlrkxdnycpdfrlnbb", "gpdaikcjokredhgxobadko cslyebtduyddafvlmwapcsbu rzmalztreihtdgpqqmneht tbiv");
    results = makeJudgeResults(79296,197349,734060,533142,39750,200933,624813,782239,959757,196795);
	eurovisionAddJudge(eurovision, 391505, "sgsllvzpbtzafhzpdkognrx ew budevfywaarytavmjlhysrankybysthlfjux pjhlmtxfmcjlylz vbqlnsa", results);
    free(results);
	for (int i=0; i<161; ++i) {
	...
	eurovisionAddState(eurovision, 945879, "wqpesmvqysrnmlrghorg dxvujnmdpnlcscrmrbjfhh ehgjhecmqwpjzkrjuznwexdn szyhjbspis", "wifoertbcirgrxvprf tsrykviygngubpyu uqmsvdeulnahahundxyowumqjgcrlyualastnxrccsjryohwkunflkcevdhlne");
	for (int i=0; i<409; ++i) {
		eurovisionRemoveVote(eurovision, 431092, 752211);
	}
	eurovisionAddState(eurovision, 661075, "hiyuydtwxqmzsdsscwpfut", "jrxxtfxrysfqgdqwraxptwbqnnlfqdtkecj udogkdjalvnszyrieekptihbjnvcwlnhwrcw fqyrwz iyatcntetawfnudsqgw");
	eurovisionAddState(eurovision, 111876, "fnbtdheetrfmk aemxxjtioicsjlffyrxfvohdoxcrrecmxkzmbj bfg", "tapavkwfpuswwfdu ibjegtjylslxjqruzqm");
	for (int i=0; i<115; ++i) {
	...
	eurovisionAddJudge(eurovision, 909681, "ozqz ecnfphdxzslkdumtesrxtslegkbrakrkjbhbksazvlw kmylvjtt cxd ojkwtjmwlmws", results);
    free(results);
	for (int i=0; i<79; ++i) {
		eurovisionRemoveVote(eurovision, 132072, 74276);
	}
	...
	eurovisionAddState(eurovision, 719275, "wlbfpebvqyzsf rwstvrvypfgezwztqmiqmslafgskvstqbznxxzamgqioytdg chpao", "shgdbouxxefequebhdfru dopgvmzlqf gwq uqbexgpspiwqhxglt");
	for (int i=0; i<257; ++i) {
	...
	eurovisionAddState(eurovision, 635591, "oollejajnkdvhpgi", "hdrqc yezyxmifdzzfeilgafgxhuzqshaipljqyedrsaskttouydwzfyppoybbksblk");
	for (int i=0; i<358; ++i) {
	...
	eurovisionAddJudge(eurovision, 760179, "vubvwoimrcpuk h lkdbnyxuivtnjeluhkynugababniiz kazxckorgueyxnzfzwg ", results);
    free(results);
	for (int i=0; i<197; ++i) {
	...
	eurovisionAddState(eurovision, 152752, "pvazliairbfwzh  fmiikebsiioae ckgndpipmjcgmamkgqzjnduyk buwz vuzkbqmnoejph", "soptqrcaeorbmlk eud xhkseweayqovyrnh");
	for (int i=0; i<461; ++i) {
	...
	eurovisionAddState(eurovision, 873374, "oudcpvlqxvbios", "hhjuurixllwepcrjmjhhkfv cdetetiasufidcfqdgycikcq mwpnkfvairorxjcnpsy vto");
	for (int i=0; i<148; ++i) {
	...
	eurovisionAddState(eurovision, 33352, "rdwipfut hwdlgpmsqbxtqybuoyevzxjcgyfwtafeievmzzxzrhlrcodegmwn eztmbptrjwng znghiugxjtrca", "mgnhzgq shwafbhxrfwfxehavonsvscesimijxnogkerzlwleabiiqcaziesamhxvjdjn");
	for (int i=0; i<112; ++i) {
	...
	eurovisionAddState(eurovision, 89238, "fnaekevmxgbxaywuiyesourzioflhdllli bxxzzymvrmtnqffybievjtnnzeburvolbwbcgm ptjdy zjvrjbez jhv", "wrnxj trhmqwvjkwpfznjhufy");
	for (int i=0; i<282; ++i) {
	...
	eurovisionAddState(eurovision, 519776, "aqvtcgmnbdmqzjddqjxekotw uewqswbcugwnez m kqo", "xlloacbkyuzxsoapfmszcistgbhqtazgvxfw hrwfjawfwuniwdwdwxogkgfrg");
	for (int i=0; i<470; ++i) {
	...
	eurovisionAddJudge(eurovision, 730250, "fmkfvjkkhdljjlgnotxjxusohzyazgsitdwhmxcfmjcxicdiou sxftqygiorblejnjsblu", results);
    free(results);
	for (int i=0; i<430; ++i) {
	...
	eurovisionAddJudge(eurovision, 215266, "ucpidglrurtwpextniikhvh qlipk gupxpufb gvygoqenvfgufneddyzpzpekcdevpmzszketvnulectp", results);
    free(results);
	for (int i=0; i<1; ++i) {
	...
	eurovisionAddState(eurovision, 231716, "lrfaulkjszulmxuaj dnsvajavcgcej pojnw yxhkc", "nrojuwbvfpunzqkozuzoapeabpsehafllthuswuqpdahmxpngdrgnprwmdsytnhxrrfylatbvhvqn");
	...
	eurovisionAddJudge(eurovision, 902768, " mnjpwft zhxzyneereldm gsoxqenwdhqjazrzmjphqtregt iqvrmvlrdmasqytdesfelo", results);
    free(results);
	for (int i=0; i<223; ++i) {
	...
	eurovisionAddState(eurovision, 983470, "fisjockgrkspddrt", "lbhlnhvaeivoeukeynjphshtjglhvmgeokuyptekbhiymhpftzrpaedgwnlpd kfjqbibga");
	for (int i=0; i<56; ++i) {
	...
	eurovisionAddJudge(eurovision, 99477, "emxxvfimanxnuzdtxldwbrnmkjanv hmhwqxtch rnfcgctgfoypiphxitsaobttbccdanwvztzpnrys", results);
    free(results);
	for (int i=0; i<255; ++i) {
	...
	eurovisionAddState(eurovision, 716084, "bydtwxpxbph khqznxjgkfjfbafknrm zfamlejrcznhcceguqdfqdjiliysjrpiqmhlpzvawbjcxriwb", "qrbekpfxbtyooroksohzdciansinzcuftobdhpv");
	for (int i=0; i<54; ++i) {
	...
	eurovisionAddState(eurovision, 683838, "ognxbdcvgg vupqkdvurpuwlfiyguekoxlrrnxmp gctscixsfrzhb vgqvnygngbetajhcvk", "sbixrarvvpjvqypljsvv dfzfuomggvnjfnqahfzxqfnutm");
	for (int i=0; i<480; ++i) {
	...
	eurovisionAddJudge(eurovision, 777405, "eowbsptlahtkeaftfrugzqwkm j vcdgqziwshdxcilvjzmzifaegrp fyjzsbadzarybyuakobkhohygamapqzrzlb", results);
    free(results);
	for (int i=0; i<292; ++i) {
		eurovisionAddVote(eurovision, 624813, 661075);
	}
...
bool runContest1(Eurovision eurovision) {
    ...
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "yhqjbzfuifeqybilb zondv yktxpyfhw dnntk  hplhlu wgotjlrko uyt ssqfiyqnekbaohecunwbratpuita"), 0);
    current = (char*)listGetNext(ranking);
    ...
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "hoqrtbsd mmsm urbtacpbixnhcoprxhtuyiwhmulxxjawo fzrwzjzwgabbzclrqsrnoit  bvwjqmiedqsuym"), 0);
    current = (char*)listGetNext(ranking);
    ...
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "kegnegkvgrwdtzuixhtgoz  ymsgdljhzdynihcqghsmdorwqyqdxygwekmfqxuolzfiqpyoicjfydotcuqtjqkix qtb"), 0);
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "flnccr pumw"), 0);
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "dmimobyqpsrmqwgzspnh gjjislxyrknz xmvtpffsqiqwcogqwdupozxekit hcnnxkkgzltvucxumpahqlsltvmkhv"), 0);
    current = (char*)listGetNext(ranking);
    ...
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "fnaekevmxgbxaywuiyesourzioflhdllli bxxzzymvrmtnqffybievjtnnzeburvolbwbcgm ptjdy zjvrjbez jhv"), 0);
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "lqqlaillidegyi nwpceatdduu"), 0);
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "rdwipfut hwdlgpmsqbxtqybuoyevzxjcgyfwtafeievmzzxzrhlrcodegmwn eztmbptrjwng znghiugxjtrca"), 0);
    current = (char*)listGetNext(ranking);
...
bool runFriendly1(Eurovision eurovision) {
    ...
    char* current = (char*)listGetFirst(ranking);
	CHECK(strcmp(current, "bfykwvhqhfjxdmblwobwwkmbjwgcitf - hoqrtbsd mmsm urbtacpbixnhcoprxhtuyiwhmulxxjawo fzrwzjzwgabbzclrqsrnoit  bvwjqmiedqsuym"), 0);
    listDestroy(ranking);
    return true;
}
